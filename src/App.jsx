...
import PagoExitoso from "./pages/cliente/PagoExitoso"; // ✅ Importación corregida

// Cargar Stripe Promise con tu clave pública de Stripe
...
function App() {
  return (
    <BrowserRouter>
      {/* Envolvemos toda la App dentro de Elements */}
      <Elements stripe={stripePromise}>
        <Routes>
          ...
          />
          <Route path="/admin/notas-venta" element={<NotasVenta />} />
          <Route path="/admin/ordenes" element={<OrdenesInternas />} />
          <Route path="/admin/detalles" element={<OrderDetails />} />
